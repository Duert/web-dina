            ...
            <main className="max-w-7xl mx-auto p-4 md:p-8 overflow-x-hidden">
                ...
                <div className="flex gap-4 mb-4 md:mb-8 border-b border-white/10 overflow-x-auto pb-2 scrollbar-hide whitespace-nowrap">
                    ...
                    <button
                        ...
                        className={`pb-4 px-2 font-medium transition-colors relative ${activeTab === 'notes' ? 'text-yellow-500' : 'text-gray-400 hover:text-white'}`}
                    >
                        Notas Internas
                    ...
                    <div className="space-y-6">
                        <AdminNotesManager
                            ...
                            onViewDetails={(id) => {
                                ...
                                setActiveTab('registrations'); // Switch back to registrations tab to show modal
                            }}
                        />
                    </div>
                ) : activeTab === 'quotas' ? (
                            ...
                            <div className="flex-1 overflow-y-auto p-6 bg-neutral-950/50">
                                ...
                                <div className="mb-8 px-4 py-4 bg-gradient-to-br from-slate-900 to-slate-800 border border-white/10 rounded-xl">
                                    {(() => {
                                        ...
                                        const responsiblesByBlock = { block1: 0, block2: 0, block3: 0, block4: 0 };
                                        ...
                                        schoolRegistrations.forEach((reg: any) => {
                                            ...
                                            if (blockId && uniqueParticipantsByBlock.hasOwnProperty(blockId)) {
                                                ...
                                                responsiblesByBlock[blockId as keyof typeof responsiblesByBlock] += responsibles.length;
